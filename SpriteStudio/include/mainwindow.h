...
private slots:
  ...
  /**
   * @brief on_animationList_itemPressed
   * @param item
   * @param column
   */
  void on_animationList_itemPressed(QTreeWidgetItem *item, int column);
...
private:
  ...
  bool m_wasPreviouslySelected = false;
   ...
   */
  void setBoundingBoxHighllithers(QModelIndexList &selectedIndexes);
